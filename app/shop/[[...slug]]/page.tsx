...
const ShopPage = (slug: any) => {
  ...
  return (
    <div className="text-black bg-white">
      <div className=" max-w-screen-2xl mx-auto px-8 max-sm:px-4">
        <Breadcrumb />
        <div className="grid grid-cols-[200px_1fr] gap-x-8 max-md:grid-cols-1 max-md:gap-y-4">
          <Filters />
          <div>
            <div className="flex justify-between items-center max-lg:flex-col max-lg:gap-y-4">
