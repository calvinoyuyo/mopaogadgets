...
import { FaCheck, FaClock, FaCircleQuestion, FaXmark, FaWhatsapp } from "react-icons/fa6";
            ...
            >
              ...
              <dl className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  ...
                  <dd className="text-sm font-medium text-gray-900">KSh5.00</dd>
                </div>
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
              ...
              {products.length > 0 && (
                <div className="mt-6 flex flex-col gap-y-3">
                  ...
                  {(() => {
                    const baseUrl = "https://wa.me/254726376277?text=";
                    const productLines = products.map((product) =>
                      `- ${product.title} (KSh ${product.price})`
                    ).join("\n");
                    const message = `Hello Mopao Gadgets 👋, I want to order the following products:\n${productLines}\n\nIs everything available? I'd like to order.`;
                    ...
                    return (
                      <a
                        ...
                        className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded font-roboto flex items-center justify-center gap-x-2"
                      >
