...
const Incentives = () => {
  return (
    <div>
      <h2 className='text-2xl text-center py-4'>Best Customer Benefits</h2>
    <div className="mx-auto max-w-screen-2xl py-8 sm:px-2 lg:px-4">
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 px-4 lg:max-w-none lg:grid-cols-3">
